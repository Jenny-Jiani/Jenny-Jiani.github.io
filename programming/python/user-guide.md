...
# User Guide for Windows Edition - python
...
- Supported Python Versions: Python2.7(It is no longer supported after DBR 7.4), Python 3.5, Python 3.6, Python 3.7, Python 3.8
