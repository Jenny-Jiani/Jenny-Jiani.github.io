        ...
        if (breakpoint() == 'lg') {
            if (sd > 65 && dcheight>0) {
                ...
                if (dcheight > document.body.clientHeight) {
                    $('#sideBarCnt.ftm-fixed').css({'height': 'auto'})
                    $('#sideBarCnt.ftm-fixed #fullTreeMenuListContainer').css({'height': 'calc(100vh - 245px)'})
                    $('.rightSideMenu.rsm-fixed').css({'height': 'calc(100vh - 260px)'})
                } 
                // else {
                //     $('#sideBarCnt.ftm-fixed').css({'height': 'auto'})
